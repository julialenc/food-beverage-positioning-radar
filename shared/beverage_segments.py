...
PREPARATION_ALCOHOL_PATTERN = re.compile(
    ...
    r"concentrado|préparations de boissons|preparations de boissons|"
    r"préparation de boissons|preparation de boissons|boissons chaudes|"
    r"drink mix|margarita mix|bloody mary mix|instant drink|"
    ...
    r"thes|the vert|the noir|the de ceylan|darjeeling|ceylon|yunnan|"
    r"oolong|sencha|matcha|infuso|tisane|tisanes|rooibos|yerba mate|"
    r"früchtetee|kräuter|kamille|camomile|chamomile|peppermint|"
    r"verveine|menthe poivree|menthe poivrée|algothe|aquarosa|tsarevna|"
    r"prince wladimir|sweet love|imperial label|bb detox|"
