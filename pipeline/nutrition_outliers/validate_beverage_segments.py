...
def main() -> None:
    cases = [
        ...
        (
            "beverages",
            "Kusmi Grøn Darjeeling, 250 G",
            "Boissons",
            PREPARATION_ALCOHOL_SEGMENT,
        ),
        ("beverages", "Algothe", "Boissons", PREPARATION_ALCOHOL_SEGMENT),
        (
            "beverages",
            "Melange de thes noirs",
            "Boissons",
            PREPARATION_ALCOHOL_SEGMENT,
        ),
        (
            "beverages",
            "Prince Wladimir",
            "Boissons, Boissons sans sucre ajouté",
            PREPARATION_ALCOHOL_SEGMENT,
        ),
        ("beverages", "Arizona Green Tea", "Boissons", READY_TO_DRINK_SEGMENT),
        (
            "beverages",
            "Lipton Ice Tea saveur pêche sans sucres",
            "Boissons au thé, Thés glacés",
            READY_TO_DRINK_SEGMENT,
        ),
        ("beverages", "Kombucha original au thé vert", "", READY_TO_DRINK_SEGMENT),
