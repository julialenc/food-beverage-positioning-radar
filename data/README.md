...
- `data/02_raw_off_downloads/` contains ignored raw Open Food Facts downloads
  regenerated by stage 01A or 01B.
- `data/03_pipeline_intermediates/` contains ignored core pipeline CSVs such as
